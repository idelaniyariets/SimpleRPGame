...
func _physics_process(delta: float) -> void:
	...
	$CanvasLayer/Attack.position = Vector2(size.x - 200, $CanvasLayer/Attack.position.y)
	$CanvasLayer/Shift.position = Vector2(size.x - 200, $CanvasLayer/Shift.position.y)
	$CanvasLayer/Block.position = Vector2(size.x - 350, $CanvasLayer/Block.position.y)
	$CanvasLayer/Change.position = Vector2(size.x - 100,$CanvasLayer/Change.position.y)
	$CanvasLayer/Jump.position = Vector2(size.x - 200, $CanvasLayer/Jump.position.y)
	$CanvasLayer/Button.position = Vector2(size.x - 50, $CanvasLayer/Button.position.y)
